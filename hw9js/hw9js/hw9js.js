...
for (const course of coursesAndDurationArray) {
    ...
    heading.innerText = `${course.title} - ${course.monthDuration}`;
...
for (const element of simpsons) {
    let div = document.createElement('div');
    div.classList = 'memeber'
    div.innerHTML = `${element.name}  ${element.surname}  ${element.age} років  ${element.info} <br> <img src="${element.photo}" alt="">`
